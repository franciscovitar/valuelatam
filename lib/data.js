...
export const solutions = [
  {
    ...
    description:
      "Alternativas de financiamiento para optimizar tu flujo de caja y costo financiero.",
  ...
  },
  {
    ...
    description:
      "Gestión de carteras y liquidez según tu horizonte, riesgo y necesidades de caja.",
    features: [
  ...
  },
  {
    ...
    description:
      "Pagos, transferencias y financiamiento import/export para operar más ágil y eficiente.",
    features: [
...
export const team = [
  {
    ...
    description:
      "Estructuración de financiamiento, inversiones y optimización de liquidez.",
    image: "/mauricio.jpeg",
    linkedin: "#",
  },
  {
    ...
    description:
      "Experiencia en banca corporativa, tesorería y financiamiento PyME (tradicional y sindicado).",
    image: "/mujer.jpeg",
    linkedin: "#",
  },
];
