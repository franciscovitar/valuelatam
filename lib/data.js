...
export const solutions = [
  ...
  },
  {
    ...
    description:"Diseño de estrategias de inversión y administración de liquidez para empresas que buscan proteger su capital y optimizar el rendimiento de sus excedentes.",
    features: [
...
export const investmentServices = [
  {
    ...
    features: ["Análisis de perfil de riesgo", "Diversificación de instrumentos", "Monitoreo y ajuste de cartera"],
  },
  {
    title: "Gestión de liquidez",
    description: "Diseño de estrategias para administrar los excedentes financieros de la empresa según horizonte y necesidades de caja.",
    features: ["Planificación de liquidez", "Gestión de excedentes transitorios", "Estrategias de corto y mediano plazo"],
  },
   {
    title: "Optimización de tesorería",
    description: "Uso de instrumentos del mercado de capitales para maximizar el rendimiento de la liquidez empresarial.",
    features: ["Fondos Comunes de Inversión (FCI)", "Cauciones bursátiles", "Estrategias de cash management"],
  },
];
